...
NCNews-API (previously named NCNews-Server) is an example Web API that is designed to run on a Node.js server and serve API requests for display on a front end application. The purpose of this application is to demonstrate my skills in Javascript and the Node.JS Javascript Framework. 
...
Want to host your own instance of this API? [Click here](#hosting-your-own-nc-news-server-instance) to skip ahead to the Hosting section of this Readme.
...
| 304         | Not Modified.                                                                                                                                                                               |
| 400         | Bad Request - The request could not be understood by the server due to malformed syntax. The message body will likely contain more information.                                                     |
